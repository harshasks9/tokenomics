  ...
  return (
    <>
      <div className="mg-terms" aria-label="Baseline terms">
        ...
        <span>12-month order form · 15 Sep 2026 – 14 Sep 2027</span>
        <span><b>$2.00</b> per user per month (list $5 − 60%)</span>
        <span title={exactUsers(REQUIRED_USERS_M12)}><b>{users(REQUIRED_USERS_M12)}</b> users at Month 12</span>
      ...
      <div className="mg-kpis">
        ...
        <Kpi k="Month-12 billed users" v={users(r.m12.billed)} s={r.m12.met ? `meets the ${users(REQUIRED_USERS_M12)} requirement` : `${users(r.m12.shortfallUsers)} short of ${users(REQUIRED_USERS_M12)}`} title={exactUsers(r.m12.billed)} tone={r.m12.met ? "good" : "bad"} />
