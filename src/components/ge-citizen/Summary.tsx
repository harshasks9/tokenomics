...
export default function Summary() {
  ...
  const answers = [
    ...
    },
    {
      ...
      why: `Three conditions: a hard per-citizen usage cap, most sessions answered by a low-cost model, and setup (${fmtMoney(i.integration)} here) contracted separately from the $${i.price.toFixed(2)}.`,
    },
  ];

  return (
    <Section id="gec-summary" eyebrow="7 · Executive summary" title="Start with one city, four services and a hard usage cap">
