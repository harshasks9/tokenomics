...
export const metadata: Metadata = {
  ...
  description:
    "Twelve months of the AI capability frontier, Aug 2025 – Aug 2026, against the Google flagship available at each moment. Google held or shared #1 for 62 of 366 days; Gemini 3.1 Pro has stood still at 46 while the frontier reached 61.",
  robots: {
    index: false,
    follow: false,
    nocache: true,
