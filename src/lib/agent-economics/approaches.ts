...
export const APPROACH_META: Record<Approach, {
  ...
  geap: {
    ...
    shortName: "Gemini Enterprise Agent Platform",
    color: "#1A73E8",
    pale: "#E8F0FE",
  ...
  claude: {
    name: "Claude Enterprise assembled stack",
    shortName: "Claude Enterprise",
    color: "#B45309",
    pale: "#FFF7ED",
  ...
  openai: {
    name: "Assembled API stack",
    shortName: "Assembled stack",
    color: "#0F766E",
    pale: "#F0FDFA",
