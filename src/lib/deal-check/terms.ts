...
export const GOOGLE = {
  ...
  sizing: t("forecast Y1 spend for the incremental commit", "documented", "Credit sizing",
    "Credits apply only to spend above the baseline and are based on the forecasted Y1 spend for the additional incremental commit. The model sizes the pool as rate × forecast Y1 incremental spend, then applies the account cap."),
  delivery: t("spend-milestone credits", "documented", "Delivery",
    "Credit rewards are spend-milestone based, scoped to the \"Anthropic on Google Private Offer\" SKU group. The source does not define the milestones; the model settles credits quarterly as spend above baseline accrues. OMPF workflow and Mithra credit resolution are documented at the support link."),
  topLine: t("top-line (undiscounted) marketplace spend", "documented", "Spend measured",
    "Credits are earned on incremental top-line Anthropic MaaS spend (Model APIs including PT) via marketplace, so the model measures marketplace spend before any GCP price discount."),
  ...
  authority: t("DPO/DPM only", "documented", "Authority and execution",
    "Only available and executed by DPO/DPM. Additional funding, discounts and other exceptions go to Deal Pricing (DPM). Sales teams must also receive the approvals outlined per go/sales-concessions before deal execution."),
  request: t(["Create an Expert Request for DPO support via the opportunity in Vector and indicate \"Anthropic MaaS offer\" in the comments (instructions: go/engageDPO).", "If an exception is needed, indicate \"Offer Exception Required\" in the DPO Expert Request and complete the exception sheet, following its READ ME tab.", "After filling out the incentive summary exception sheet, notify the sub-regional DPO contact; for specific questions reach the DPO SME team after completing go/engageDPO."], "documented", "How to request",
    "Execution steps from the offer summary."),
